...
For the optimal test between $P_{\mathrm{in}}$ and $P_{\mathrm{out}}$, the
Bretagnolle-Huber inequality~\cite{bretagnolle1979estimation} bounds the
total variation, and hence the advantage, by the KL divergence:
\begin{equation}
