...
We consider two principals: a \emph{data holder} who trains a model on
$D$ and may later publish it, and an \emph{adversary} who infers membership.
...
\emph{Black-box} access: the adversary submits inputs and observes
...
Before training, compute $\mathrm{DPRI}(D)$ from raw data alone---no
