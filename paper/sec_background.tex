...
This is the standard setting for deployed APIs and MLaaS
platforms~\cite{shokri2017membership,truex2019demystifying}, and the
weakest, hence most broadly applicable, adversary
model~\cite{salem2019ml}; white-box access only strengthens the
attacks we consider~\cite{nasr2019comprehensive,leino2020stolen}.
