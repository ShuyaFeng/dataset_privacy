...
collection of or interaction with human subjects. All experiments use
publicly available, previously released datasets (Adult, COMPAS,
Purchase100, Texas100, Pima Indians Diabetes, MovieLens-1M, and Gowalla).
...
datasets solely to \emph{measure} membership inference risk, never to make
...
privacy risk \emph{before} training, an adversary with access to candidate
