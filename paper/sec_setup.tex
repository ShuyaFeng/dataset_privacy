...
repository~\cite{dua2019uci}. Table~\ref{tab:datasets} shows a
...
MLP (two hidden layers, 128-64, trained with Adam~\cite{kingma2015adam}
for 100 epochs on GPU), XGBoost~\cite{chen2016xgboost} (300 trees,
depth 6), and Random Forest~\cite{breiman2001random} (300 trees,
unbounded depth).
